...
public class MultiSessionTelegramBot extends TelegramLongPollingBot {
     ...
     * This refers to buttons that were added to the message.
     */
    ...
    /**
     * The method sends TEXT (text message) to the chat.
     * Markdown markup is supported.
     */
    ...
    /**
     * The method sends a PHOTO (picture) to the chat.
     * The picture is specified by the key - photoKey.
     * All pictures are contained in the resources/images folder.
     */
    ...
    /**
     * The method sends a PHOTO (picture) and TEXT to the chat.
     * The picture is specified by the key - photoKey.
     * All pictures are contained in the resources/images folder.
     */
    ...
    /**
     * The method changes the TEXT in an already sent message.
     */
    ...
    /**
     * Message with buttons (Inline Buttons)
     */
